 ...
 *    Has Setting For Level Transition Time (as fast as possible or set an explicit time)
...
metadata {
    definition(name: 'Candeo C210 Zigbee Dimming Smart Plug', namespace: 'Candeo', author: 'Candeo', importUrl: 'https://raw.githubusercontent.com/candeosmart/hubitat-zigbee/main/Candeo%20C210%20Zigbee%20Dimming%20Smart%20Plug.groovy', singleThreaded: true) {
        ...
        fingerprint profileId: '0104', endpointId: '01', inClusters: '0000,0003,0004,0005,0006,0008,0301,0B05,1000', outClusters: '0019', manufacturer: 'Candeo', model: 'C210', deviceJoinName: 'Candeo C210 Zigbee Dimming Smart Plug'
        fingerprint profileId: '0104', endpointId: '01', inClusters: '0000,0003,0004,0005,0006,0008,0B05,1000,FC57', outClusters: '0019', manufacturer: 'Candeo', model: 'C210', deviceJoinName: 'Candeo C210 Zigbee Dimming Smart Plug'
    }
    preferences {
        ...
        input name: 'levelTransitionTime', type: 'enum', title: 'Level Transition Time (s)', description: '<small>When setting the device to a specific level, use this as the default transition time if one is not specified explicitly.</small><br><br>', options: PREFLEVELTRANSITIONTIME, defaultValue: 'none'
...
private @Field final Map PREFLEVELTRANSITIONTIME = ['none': 'as fast as possible', '500': '0.5s', '1000': '1s', '1500': '1.5s', '2000': '2s', '2500': '2.5s', '3000': '3s', '3500': '3.5s', '4000': '4s', '4500': '4.5s', '5000': '5s']
...
List<String> updated() {
    ...
    logInfo("levelTransitionTime setting is: ${PREFLEVELTRANSITIONTIME[levelTransitionTime ?: 'none']}", true)
...
List<String> setLevel(BigDecimal level) {
    ...
    logDebug("levelTransitionTime: ${levelTransitionTime ?: 'none'}")
...
List<String> startLevelChange(String direction) {
    ...
    Integer scaledRate = levelChangeRate ? levelChangeRate == 'none' ? 254 : percentageValueToLevel(levelChangeRate.toBigDecimal()) : 255
