/**
 *    Candeo C-ZB-LC20 Smart LED Controller (RGB Mode)
 *    Supports Momentary Switches
 *    Supports on / off / setLevel / startLevelChange / stopLevelChange / setColor / setHue / setSaturation / flash
 *    Reports switch / level / rgb / color / colorName / hue / saturation / colorMode events
...
List<String> setLevel(BigDecimal level) {
    logTrace("setLevel called value: ${level}")
