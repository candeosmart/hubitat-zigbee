...
metadata {
    definition(name: 'Candeo C-ZB-RD1 Zigbee Rotary Dimmer', namespace: 'Candeo', author: 'Candeo', importUrl: 'TBA', singleThreaded: true) {
        ...
        fingerprint profileId: '0104', endpointId: '01', inClusters: '0000,0003,0004,0005,0006,0008,0702,0B04,1000', outClusters: '0003,0019', manufacturer: 'Candeo', model: 'C-ZB-RD1', deviceJoinName: 'Candeo C-ZB-RD1 Zigbee Rotary Dimmer'
    }
    preferences {
...
private @Field final String CANDEO = 'Candeo C-ZB-RD1 Device Driver'
